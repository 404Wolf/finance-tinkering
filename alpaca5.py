...
client = StockHistoricalDataClient(
    "PKJTWFG3XHXYWYVFBDXEZYHI4Q",
    "GKHXbdZb6FLTEG9zEhhUpVJzbQDACyEaZNP554dqruws"
)

ALPHAVANTAGE_API_KEY = "F7ETJVO7T3NXX99K"
...
if not result.empty:
    ...
    print(f"Number of Spikes > (threshold={threshold:.2f}): {count_above_3pct}")
